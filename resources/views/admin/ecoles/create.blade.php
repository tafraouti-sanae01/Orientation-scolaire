    ...
    <div class="row">
        ...
        <div class="col-md-10 px-4 py-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h2 class="fw-bold text-dark mb-1">Ajouter une école</h2>
                    <p class="text-muted mb-0">Créer une nouvelle école pour les étudiants</p>
                </div>
                <div class="text-end">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="type" name="type" required>
                                        ...
                                        <option value="Semi-public" {{ old('type') == 'Semi-public' ? 'selected' : '' }}>Semi-public</option>
                                        <option value="Privé" {{ old('type') == 'Privé' ? 'selected' : '' }}>Privé</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="universite" name="universite" value="{{ old('universite') }}" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="frais" name="frais" required>
                                        ...
                                        <option value="Gratuit" {{ old('frais') == 'Gratuit' ? 'selected' : '' }}>Gratuit</option>
                                        <option value="Payant" {{ old('frais') == 'Payant' ? 'selected' : '' }}>Payant</option>
                                        <option value="Variable" {{ old('frais') == 'Variable' ? 'selected' : '' }}>Variable</option>
                                    </select>
                                </div>
                                
                                <div class="mb-3">
                                    <label for="seuils" class="form-label">Seuils d'admission *</label>
                                    <input type="text" class="form-control" id="seuils" name="seuils" value="{{ old('seuils') }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="d-grid gap-2">
                                    <button type="submit" class="btn btn-success">
                                        <i class="fas fa-plus me-2"></i>Ajouter l'école
                                    </button>
