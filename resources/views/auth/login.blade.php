...
<div class="container">
    <div class="login-card row mx-auto bg-white">
        ...
        <div class="col-md-6 p-5">
            ...
            <p class="mb-4 text-muted">Connectez-vous à votre compte E-Tawjihi !</p>
    <form method="POST" action="{{ route('login') }}">
        @csrf
            ...
            <div class="mt-4 text-center">
                Vous n'avez pas de compte ? <a href="{{ route('register') }}" class="text-primary fw-bold">S'inscrire</a>
            </div>
        </div>
    </div>
</div>
